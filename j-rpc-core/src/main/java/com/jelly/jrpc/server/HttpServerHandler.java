...
public class HttpServerHandler implements Handler<HttpServerRequest> {
    ...
    public void handle(HttpServerRequest request) {
        ...
        request.bodyHandler(body -> {
            ...
            if (rpcRequest == null) {
                ...
                doRespone(request, rpcResponse, serializer);
                return;
            }
     ...
     * @param serializer
     */
    void doRespone(HttpServerRequest request, RpcResponse rpcResponse, Serializer serializer) {
